...
scan_params_filepath = path.abspath(r'F:\oct_scan_large_xml_cylinder\scan_param.txt')
ec1000_xml_savepath = path.abspath(r'F:\oct_scan_large_xml_cylinder\oct_scan.xml')
